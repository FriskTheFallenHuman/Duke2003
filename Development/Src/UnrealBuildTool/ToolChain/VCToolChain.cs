	...
	class VCToolChain
	{
		...
		{	
			...
			else
			{
				...
				else
				{
					...
					{
                        VCToolPath = Path.Combine("C:\\Program Files (x86)\\Microsoft Visual Studio 9.0\\Common7\\Tools\\", "../../VC/bin/x86_amd64/" + ToolName + ".exe");
					}
					...
					{
                        VCToolPath = Path.Combine("C:\\Program Files (x86)\\Microsoft Visual Studio 9.0\\Common7\\Tools\\", "../../VC/bin/amd64/" + ToolName + ".exe");
					}
					...
					{
                        VCToolPath = Path.Combine("C:\\Program Files (x86)\\Microsoft Visual Studio 9.0\\Common7\\Tools\\", "../../VC/bin/" + ToolName + ".exe");
					}
				}
			}
		...
		static void InitializeEnvironmentVariables( CPPTargetPlatform Platform )
		{
			if( !bAreEnvironmentVariablesAlreadyInitialized )
			{
				...
				{
					VCVarsBatchFile = Path.Combine( "C:\\Program Files (x86)\\Microsoft Visual Studio 9.0\\Common7\\Tools\\", "../../VC/bin/x86_amd64/vcvarsx86_amd64.bat" );
				}
				// The 32 bit vars batch file in the binary folder simply points to the one in the common tools folder.
				else
				{
                    VCVarsBatchFile = Path.Combine("C:\\Program Files (x86)\\Microsoft Visual Studio 9.0\\Common7\\Tools\\", "vsvars32.bat");
				}

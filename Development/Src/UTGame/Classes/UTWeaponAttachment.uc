...
//custom UDK Ultimate player hit gore effect//		
if(Pawn(HitActor) != none)
           {
             WorldInfo.MyEmitterPool.SpawnEmitter(ParticleSystem'T_FX_UT3.Effects.P_FX_Bloodhit_01_Far', HitLocation, rotator(HitNormal), HitActor);

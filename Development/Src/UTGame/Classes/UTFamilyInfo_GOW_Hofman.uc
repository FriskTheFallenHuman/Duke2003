...
class UTFamilyInfo_GOW_Hofman extends UTFamilyInfo
    abstract;
...
defaultproperties
{
	...
	CharacterMesh=SkeletalMesh'UT3_Model_Hofman.UT3_Model_Hofman'
	...
	SoundGroupClass=class'UTPawnSoundGroup_Hofman'
	VoiceClass=class'UTVoice_Hofman'

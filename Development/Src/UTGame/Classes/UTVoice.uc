...
var Array<SoundNodeWave> TauntSounds; //udk ultimate custom taunts
...
const TAUNTINDEXSTART = 0; //udk ultimate custom taunts
...
static function int GetMessageIndex(Controller Sender, PlayerReplicationInfo Recipient, Name Messagetype, class<DamageType> DamageType)
{
    ...
    {
		case 'TAUNT':
			return GetTauntMessageIndex(Sender, Recipient, Messagetype, DamageType); //udkultimate custom taunts
			//return -1;

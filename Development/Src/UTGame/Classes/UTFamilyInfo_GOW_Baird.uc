...
class UTFamilyInfo_GOW_Baird extends UTFamilyInfo
    abstract;
...
defaultproperties
{
	...
	CharacterMesh=SkeletalMesh'UT3_Model_Baird.UT3_Model_Baird'
	...
	SoundGroupClass=class'UTPawnSoundGroup_Baird'
	VoiceClass=class'UTVoice_Baird'

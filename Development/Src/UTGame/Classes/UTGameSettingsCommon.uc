...
defaultproperties
{
	...
	PropertyMappings(2)=(Id=PROPERTY_GOALSCORE,Name="GoalScore",MappingType=PVMT_PredefinedValues,PredefinedValues=((Type=SDT_Int32, Value1=30), (Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30),(Type=SDT_Int32, Value1=30)))

	//time limit 0
	Properties(3)=(PropertyId=PROPERTY_TIMELIMIT,Data=(Type=SDT_Int32,Value1=0),AdvertisementType=ODAT_OnlineService)
	PropertyMappings(3)=(Id=PROPERTY_TIMELIMIT,Name="TimeLimit",MappingType=PVMT_PredefinedValues,PredefinedValues=((Type=SDT_Int32, Value1=0), (Type=SDT_Int32, Value1=0),(Type=SDT_Int32, Value1=0),(Type=SDT_Int32, Value1=0),(Type=SDT_Int32, Value1=0),(Type=SDT_Int32, Value1=0),(Type=SDT_Int32, Value1=0),(Type=SDT_Int32, Value1=0)))

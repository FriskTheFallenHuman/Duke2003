...
class UTFamilyInfo_GOW_Locust_Grunt extends UTFamilyInfo
    abstract;
...
defaultproperties
{
	...
	CharacterMesh=SkeletalMesh'UT3_Model_Locust_Grunt.UT3_Model_Locust_Grunt'
	...
	SoundGroupClass=class'UTPawnSoundGroup_Locust'
	VoiceClass=class'UTVoice_Locust'

...
public:
	...
	public:
			...
			)
		{
			...
			if (NumElements > 0)
			{
				DWORD AlignedSize = Align<DWORD>(NumElements * NumBytesPerElement,Alignment);
				Data = (ElementType*)appPhysicalAlloc(AlignedSize, bNeedsCPUAccess ? CACHE_Normal : CACHE_WriteCombine);
			}
		}
		INT CalculateSlack(
			INT NumElements,

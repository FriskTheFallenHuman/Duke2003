...
public:
	...
	/** default constructor */
	FXeIndexBuffer(DWORD InUsageFlags,DWORD InNumInstances)
	:	FXeGPUResource(new IDirect3DIndexBuffer9, InUsageFlags)
	,	NumInstances(InNumInstances)
	{
	}

	/** constructor initialized w/ existing D3D resource */
	FXeIndexBuffer(IDirect3DIndexBuffer9* InResource, DWORD InUsageFlags,DWORD InNumInstances)

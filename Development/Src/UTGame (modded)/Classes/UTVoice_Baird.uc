 ...
 */
class UTVoice_Baird extends UTVoice
	abstract;
...
defaultproperties
{
	...
	TauntSounds(0)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.AllClear'
	TauntSounds(1)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.AreYouKiddingMe_02'
	TauntSounds(2)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.BackInYourHole'
	TauntSounds(3)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.Boom_02'
	TauntSounds(4)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.ComeAndGetMe'
	TauntSounds(5)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.DieAlready'
    TauntSounds(6)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.Easy'
	TauntSounds(7)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.EatDirtAndDie'
	TauntSounds(8)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.EatShitAndDie_03'
	TauntSounds(9)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.FuckingShit'
	TauntSounds(10)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.GoodNight'
	TauntSounds(11)=SoundNodeWave'A_VoicePack_GEARSofWAR_Baird.ICanDoThatAllDayLong'

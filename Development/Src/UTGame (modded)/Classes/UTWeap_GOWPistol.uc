class UTWeap_GOWPistol extends UTWeapon;
...
defaultproperties
{
    ...
    Begin Object Name=FirstPersonMesh
        SkeletalMesh=SkeletalMesh'WP_GOW.Mesh.WP_GOWPistol_P1'
        FOV=60
        Animations=MeshSequenceA
        AnimSets(0)=AnimSet'WP_GOW.Anims.PISTOL_BASE1'
        bForceUpdateAttachmentsInTick=True
        Scale=0.7000000
    End Object

    Begin Object Name=PickupMesh
        SkeletalMesh=SkeletalMesh'WP_GOW.Mesh.WP_GOWPistol_P3'
        Scale=0.9000000
    End Object
	
	ArmsAnimSet=AnimSet'WP_GOW.Anims.PISTOL_ARMS'
    ...
    WeaponProjectiles(0)=class'UTProj_GOWPistol'
    ...
    AttachmentClass=Class'UTAttachment_GOWPistol'

...
class UTFamilyInfo_GOW_Gus extends UTFamilyInfo
    abstract;
...
defaultproperties
{
	...
	CharacterMesh=SkeletalMesh'UT3_Model_Gus.UT3_Model_Gus'
	...
	SoundGroupClass=class'UTPawnSoundGroup_Gus'
	VoiceClass=class'UTVoice_Gus'

...
defaultproperties
{
    ...
    WeaponProjectiles(0)=class'UTProj_Stinger'
   
	//sounds
    WeaponEquipSnd=SoundCue'WP_Stinger.Sounds.A_Weapon_Stinger_Raise01_Cue'
    WeaponPutDownSnd=SoundCue'WP_Stinger.Sounds.A_Weapon_Stinger_Lower01_Cue'
    WeaponFireSnd(0)=SoundCue'WP_Stinger.Sounds.A_Weapon_Stinger_Fire01_Cue'
    PickupSound=SoundCue'WP_Stinger.Sounds.A_Weapon_Stinger_Raise01_Cue'

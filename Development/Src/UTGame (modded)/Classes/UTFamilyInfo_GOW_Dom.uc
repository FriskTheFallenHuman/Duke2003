...
class UTFamilyInfo_GOW_Dom extends UTFamilyInfo
    abstract;
...
defaultproperties
{
	...
	CharacterMesh=SkeletalMesh'UT3_Model_Dom.UT3_Model_Dom'
	...
	SoundGroupClass=class'UTPawnSoundGroup_Dom'
	VoiceClass=class'UTVoice_Dom'

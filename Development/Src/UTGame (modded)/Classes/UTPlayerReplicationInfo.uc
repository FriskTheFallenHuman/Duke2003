...
//player replicant info defines the default player skin mesh
...
defaultproperties
{
	...
	//VoiceClass=class'UTGame.UTVoice_Marcus'
    //VoiceClass=class'UTGame.UTVoice_Baird'
	//VoiceClass=class'UTGame.UTVoice_Dom'
	//VoiceClass=class'UTGame.UTVoice_Gus'
	...
	CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Marcus'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Baird'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Dom'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Gus'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Hofman'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Locust'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Locust_Grunt'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Locust_Raam'
	//CharClassInfo=class'UTGame.UTFamilyInfo_GOW_Locust_Theron'
}
